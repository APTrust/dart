...
var bagUploadForm = compileHTML(readFile('bag_upload', 'form.html'));
...
var jobRerunModal = compileHTML(readFile('job', 'rerun_modal.html'));
...
var storageServiceTest = compileHTML(readFile('storage_service', 'connection_test.html'));
...
module.exports.jobRerunModal = jobRerunModal;
...
module.exports.storageServiceTest = storageServiceTest;
