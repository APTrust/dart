...
CREATE TABLE "jobs" ("id" integer primary key autoincrement,"created_at" datetime,"updated_at" datetime,"deleted_at" datetime,"bag_id" bigint,"file_id" bigint,"workflow_id" bigint,"workflow_snapshot" varchar(255),"scheduled_start_time" datetime,"started_at" datetime,"finished_at" datetime,"pid" integer,"outcome" varchar(255),"captured_output" varchar(255) );
...
CREATE TABLE "workflows" ("id" integer primary key autoincrement,"created_at" datetime,"updated_at" datetime,"deleted_at" datetime,"name" varchar(255),"description" varchar(255),"serialization_format" varchar(255),"bag_it_profile_id" bigint,"storage_service_id" bigint );
INSERT INTO "workflows" VALUES(1,'2017-09-30 10:07:20.297647775-04:00','2017-09-30 10:07:20.297647775-04:00',NULL,'APTrust - Med School bag and upload','Create an APTrust bag with default sender data from the Med school and upload it to the APTrust demo environment','tar',1,1);
INSERT INTO "workflows" VALUES(2,'2017-09-30 10:08:33.244179042-04:00','2017-09-30 10:08:33.244179042-04:00',NULL,'APTrust - Law School bag and upload','Create an APTrust bag with default sender info from the law school and upload it to the APTrust demo server.','tar',3,1);
INSERT INTO "workflows" VALUES(3,'2017-09-30 10:09:11.952084291-04:00','2017-09-30 10:09:11.952084291-04:00',NULL,'DPN - Local backup','Create a DPN bag and send it to the FTP server in our local data center.','tar',2,2);
...
INSERT INTO "sqlite_sequence" VALUES('workflows',3);
