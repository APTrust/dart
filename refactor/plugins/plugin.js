 ...
 *           a FormatReader, this property should be an empty array.
 ...
 *           to read types ['.tar', '.tar.gz', '.tgz']. If your plugin is not
 *           a FormatWriter, this property should be an empty array.
 ...
 *           be an empty list.
 * @property {string} talksToRepository - This describes what type of repository
 *           your plugin talks to. For example, 'fedora', 'aptrust', etc. This
 *           applies only to plugins of type Repository. If your plugin is not
 *           a Repository plugin, this should be an empty string.
 *
 */
