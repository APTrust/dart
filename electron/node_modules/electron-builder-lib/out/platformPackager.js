...
class PlatformPackager {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            if (custom === undefined) {
                ...
                if ((yield (0, (_fs || _load_fs()).statOrNull)(p)) == null) {
                    ...
                    if ((yield (0, (_fs || _load_fs()).statOrNull)(p)) == null) {
                        throw new Error(`Cannot find specified resource "${custom}", nor relative to "${resourcesDir}", neither relative to project dir ("${_this6.projectDir}")`);
                    }
                }
                return p;
            }
    ...
    getOrConvertIcon(format) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            if (iconPath != null) {
                return (yield _this7.resolveIcon([iconPath], format))[0].file;
            }
    ...
    resolveIcon(sources, outputFormat) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            const arg = ["icon", "--format", outputFormat, "--root", _this8.buildResourcesDir, "--root", _this8.projectDir];
            for (const source of sources) {
                arg.push("--input", source);
            }
            const rawResult = yield (0, (_builderUtil || _load_builderUtil()).exec)((yield (0, (_tools || _load_tools()).getAppBuilderTool)()), arg, {
                cwd: _this8.projectDir,
                env: Object.assign({}, process.env, {
                    ...
                    TMPDIR: yield _this8.info.tempDirManager.rootTempDir, DEBUG: (_builderUtil || _load_builderUtil()).log.isDebugEnabled ? "true" : "false" })
            });
            let result;
            try {
