...
class LinuxTargetHelper {
    ...
    getIcns() {
        ...
        return iconPath == null ? null : _path.resolve(this.packager.projectDir, iconPath);
    }
    ...
    writeDesktopEntry(targetSpecificOptions, exec, destination, extra) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            const tempFile = destination || (yield _this2.packager.getTempFile(`${_this2.packager.appInfo.productFilename}.desktop`));
