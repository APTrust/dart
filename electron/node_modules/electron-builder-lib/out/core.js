...
exports.MisConfigurationError = exports.DIR_TARGET = exports.DEFAULT_TARGET = exports.Target = exports.Platform = undefined;
...
class Target {
    ...
    logBuilding(targetPresentableName, artifactPath, arch) {
        (_builderUtil || _load_builderUtil()).log.info({ target: targetPresentableName, arch: (_builderUtil || _load_builderUtil()).Arch[arch], file: (_builderUtil || _load_builderUtil()).log.filePath(artifactPath) }, "building");
    }
    checkOptions() {
        // ignore
...
class MisConfigurationError extends Error {
    constructor(message, code = "ERR_ELECTRON_BUILDER_MIS_CONFIGURATION") {
        super(message);
        this.code = code;
    }
}
exports.MisConfigurationError = MisConfigurationError; //# sourceMappingURL=core.js.map