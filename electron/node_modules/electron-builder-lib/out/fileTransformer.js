...
function createTransformer(srcDir, extraMetadata) {
    ...
    return file => {
        if (file === mainPackageJson) {
            ...
            return (0, (_fsExtraP || _load_fsExtraP()).readFile)(file, "utf-8").then(it => cleanupPackageJson(JSON.parse(it), false)).catch(e => (_builderUtil || _load_builderUtil()).log.warn(e));
        } else {
            return null;
        }
    };
