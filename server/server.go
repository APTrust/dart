...
func main() {
	...
	r.HandleFunc("/app_setting/new", Wrap(env, handlers.AppSettingGetForm)).Methods("GET")
	r.HandleFunc("/app_setting/new", Wrap(env, handlers.AppSettingPostForm)).Methods("POST", "PUT")
	r.HandleFunc("/app_setting/{id:[0-9]+}/edit", Wrap(env, handlers.AppSettingGetForm)).Methods("GET")
	r.HandleFunc("/app_setting/{id:[0-9]+}/edit", Wrap(env, handlers.AppSettingPostForm)).Methods("POST", "PUT")
	...
	r.HandleFunc("/profile/{id:[0-9]+}/edit", Wrap(env, handlers.ProfileGetForm)).Methods("GET")
	r.HandleFunc("/profile/{id:[0-9]+}/edit", Wrap(env, handlers.ProfilePostForm)).Methods("POST", "PUT")
	r.HandleFunc("/storage_services", Wrap(env, handlers.StorageServicesList))
	r.HandleFunc("/storage_service/new", Wrap(env, handlers.StorageServiceGetForm)).Methods("GET")
